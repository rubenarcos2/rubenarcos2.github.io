...
<p style="text-align: center;"><em>automatizar procesos mi definiciÃ³n. </em></p>
</li>
 	<li style="display: inline-block;"><a href="http://localhost/wp-content/plugins/pdfjs-viewer-shortcode/pdfjs/web/viewer.php?file=https%3A%2F%2Fwww.rarcos.com%2FCV%2Fcv_ruben_arcos_web.pdf&amp;download=true&amp;print=false&amp;openfile=false" target="_blank" rel="noopener noreferrer"><img class="wp-image-763 aligncenter" src="http://localhost/wp-content/uploads/2015/10/cv_pdf.png" alt="Descargar CV en PDF" width="64" height="64" /></a></li>
</ul>
<h2>Mi trayectoria profesional y acadÃ©mica:</h2>
